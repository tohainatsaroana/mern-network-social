  ...
  const photoURL = values.user._id ?'/api/users/photo/'+ values.user._id : '/api/users/defaultphoto'
    return (<div className={classes.root}>
      ...
      <CardContent className={classes.cardContent}>
        <TextField
            placeholder="Ecrire quelques choses ..."
            multiline
            rows="3"
            value={values.text}
      ...
      <CardActions>
        <Button color="primary" variant="contained" disabled={values.text === ''} onClick={clickPost} className={classes.submit}>PUBLIER</Button>
      </CardActions>
    </Card>
  </div>)
